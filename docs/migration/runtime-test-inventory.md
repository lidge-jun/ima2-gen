...
Total: 123 (runtime: 37, contract: 86)

## Runtime-importing tests
- `tests/api-provider-parity.test.js`
- `tests/billing-source.test.js`
- `tests/card-news-contract.test.js`
- `tests/cli-error-hints.test.js`
- `tests/cli-lib.test.js`
- `tests/comfy-bridge-contract.test.js`
- `tests/error-classify.test.js`
- `tests/generate-route-validation-error.test.js`
- `tests/generation-errors.test.js`
- `tests/history-metadata-fallback.test.js`
- `tests/history-tombstone.test.js`
- `tests/image-metadata-route.test.js`
- `tests/image-metadata-xmp.test.js`
- `tests/image-model.test.js`
- `tests/inflight-persistence.test.js`
- `tests/inflight.test.js`
- `tests/local-import-contract.test.js`
- `tests/logging.test.js`
- `tests/node-parent-source-contract.test.js`
- `tests/node-route-refs.test.js`
- `tests/node-streaming-sse.test.js`
- `tests/node-validation-error-contract.test.js`
- `tests/oauth-normalize.test.js`
- `tests/oauth-proxy-error-safety.test.js`
- `tests/open-directory.test.js`
- `tests/prompt-discovery-contract.test.js`
- `tests/prompt-fidelity.test.js`
- `tests/prompt-import-folder-contract.test.js`
- `tests/prompt-import-github-contract.test.js`
- `tests/prompt-index-ranking-contract.test.js`
- `tests/reference-image-compress.test.js`
- `tests/refs-size.test.js`
- `tests/request-logging.test.js`
- `tests/runtime-ports.test.js`
- `tests/star-prompt.test.js`
- `tests/storage-migration.test.js`
- `tests/style-sheet.test.js`
