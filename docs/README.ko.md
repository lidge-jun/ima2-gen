...
앱 기본값은 빠른 로컬 반복에 맞춘 **`gpt-5.4-mini`**입니다. 안정적인 균형을 원하면 **`gpt-5.4`**로 전환하는 것을 권장합니다.
...
- 배경 정리 seed를 찍고 mask를 미리 본 뒤 canvas version으로 저장할 수 있습니다.
...
![파일 drop, GitHub folder preview, curated source, discovered prompt 결과가 보이는 prompt import dialog](../assets/screenshots/prompt-import-dialog.png)
