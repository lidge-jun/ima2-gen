...
- `.home-hero__mark`, `.home-hero__title`, `.home-workspace h2`,
  ...
  **320/480/481/767/768/769/1279/1280/1920 아홉 폭 전부**에서 기록하고, 사다리
  표와 일치하며 경계에서 감소하지 않는지 확인. h2는 앞선 판에서 빠져 있었습니다.
- 사다리는 경계에서 크게 뜁니다(mark 480->481 +32, 1279->1280 +32). 각 경계
  양쪽 캡처를 나란히 두고, 점프가 레이아웃을 밀어 다음 섹션을 첫 화면 밖으로
  내보내지 않는지 확인합니다.
- 같은 아홉 폭에서 네 요소의 `scrollWidth`가 부모 `clientWidth`를 넘지 않는지.
  히어로 마크는 96~176px 단일 글자라 특히 481과 1280에서 확인이 필요합니다.
...
측정은 라이트/다크 x 320/390/768/1280/1920에서 돌립니다. 아홉 폭이 필요한 wp3
항목만 480/481/767/769/1279를 추가합니다.
