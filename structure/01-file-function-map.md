...
| `lib/imageModels.ts` | 399 | Image model allowlist and `normalizeImageModel(ctx, raw)` helper |
...
| Image models | `ui/src/lib/imageModels.ts` | 248 | UI-side image model labels and `resolveCoreModelValue` lane gating |
